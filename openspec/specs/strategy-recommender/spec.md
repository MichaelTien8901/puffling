# strategy-recommender Specification

## Purpose
Multi-strategy sweep service that runs optimization across all strategy types, compares results globally, and recommends the best-fit strategy with confidence metrics.
