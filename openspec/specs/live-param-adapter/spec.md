# live-param-adapter Specification

## Purpose
Background service that monitors strategy performance, detects regime changes, and triggers rolling re-optimization with safety constraints.
