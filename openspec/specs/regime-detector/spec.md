# regime-detector Specification

## Purpose
Market regime classification using rolling statistics to detect volatility breakouts and trend reversals, triggering adaptation events.
